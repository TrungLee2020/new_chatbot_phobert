...
BATCH_SIZE = 8
SAVE_PATH_MODEL = 'results/'

class Trainer():
    def __init__(self, model, optimizer, device, loss_fn, scheduler=None):
        self.model = model
    ...
    def train_epoch(self, train_data_loader):
        ...
        acc = correct.double() / len(train_data_loader)
        return avg_loss, acc
    ...
    def eval_epoch(self, val_data_loader):
        ...
        with torch.inference_mode():
            ...
            acc = correct.double()/ len(val_data_loader)
            return avg_loss, acc
    ...
    def train(self, epochs, patience, train_loader, val_loader):
        ...
        for epoch in range(epochs):
            ...
            if avg_val_loss < best_val_loss:
                ...
                torch.save(best_model.state_dict(), 'saved_weights.pth')
                _patience = patience
            else:
                _patience -= 1
            if not _patience:
